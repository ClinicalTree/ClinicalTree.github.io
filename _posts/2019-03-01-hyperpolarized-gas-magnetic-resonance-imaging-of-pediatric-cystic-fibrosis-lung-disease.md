...
author: [Giles Santyr PhD,Nikhil Kanhere MSc,Felipe Morgado MSc,Jonathan H. Rayment MDCM MSc,Felix Ratjen MD PhD,Marcus J. Couch PhD]
...
![Figure 6, Pulmonary exacerbation case study. Coronal center slice static ventilation images acquired using HP 129 Xe MRI (a) before and (b) after inpatient IV antibiotic treatment for a subacute decline in FEV 1 and pseudomonas aeruginosa eradication. The yellow arrows indicate areas where the ventilation defects improved after treatment (VDP decreased from 19.4% to 16.0%). This improvement was reflected in LCI, but not in FEV 1 . Color version of figure is available online. FEV 1 , volume in 1 second; HP, hyperpolarized; LCI, lung clearance index; MRI, magnetic resonance imaging. (Color version of figure is available online.)](https://storage.googleapis.com/dl.dentistrykey.com/clinical/HyperpolarizedGasMagneticResonanceImagingofPediatricCysticFibrosisLungDisease/5_1s20S1076633218302708.jpg)
