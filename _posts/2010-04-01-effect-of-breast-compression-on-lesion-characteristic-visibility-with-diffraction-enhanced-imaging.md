...
author: [Laura S. Faulconer PhD,Chris A. Parham MD PhD,Dean M. Connor PhD,Cherie Kuzmiak DO,Marcia Koomen MD,Yeonhee Lee MD PhD,Kyu Ran Cho MD PhD,Josh Rafoth MD,Chad A. Livasy MD,Eunhee Kim BS,Donglin Zeng PhD,Elodia Cole MS,Zhong Zhong PhD,Etta D. Pisano MD]
...
The _P_ values were calculated based on the calculated means, standard errors, and a 95% confidence interval (CI). Radiologist perception of lesion visibility for a 50% difference in tissue thickness in cadaveric specimens approached significance (bold).
